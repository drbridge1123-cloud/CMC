    <style>
    /* ── Preview & Send Modal (unique styles) ── */
    ...
    <!-- Preview & Send Modal -->
    <div x-show="showPreviewModal" class="sp-modal-overlay"
        style="display:none;" @keydown.escape.window="showPreviewModal && closePreviewModal()">
        <div class="fixed inset-0" @click="closePreviewModal()"></div>
        <div class="sp-modal-box sp-modal-box-lg relative z-10" @click.stop>

            <!-- Header -->
            <div class="sp-modal-header">
                <div>
                    <h3 class="sp-modal-title" x-text="isEditingLetter ? 'Edit Request Letter' : 'Preview Request Letter'"></h3>
                ...
                <div class="psm-header-actions">
                    ...
                    <button class="sp-modal-close" @click="closePreviewModal()">
            ...
            <div class="psm-toolbar">
                <div class="sp-form-grid-2">
                    <div>
                        <label class="sp-form-label" x-text="previewData.method === 'email' ? 'Recipient Email' : 'Recipient Fax Number'"></label>
